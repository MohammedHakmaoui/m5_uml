class Client: 
    def __init__(self, nom: str, adreca: str, telefon: str, email: str):
        ...
        self.telefon = telefon  # Número de telefon del client
        self.email = email  # Correu electronic del client
...
class UsuariWeb:
    def __init__(self, login: str, password: str, estat: str):
        ...
        self.estat = estat  # Estat de l'usuari (actiu, inactiu...)
...
class Factura:
    def __init__(self, codi_factura: str, adreca_facturacio: str, data_emissio: str, data_tancament: str, pagament: str):
        ...
        self.pagament = pagament  # Metode de pagament de la factura
...
class LiniaComanda:
    def __init__(self, producte: Producte, quantitat: int, preu: float):
        ...
        self.preu = preu  # Preu per producte
